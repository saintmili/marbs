...
# Mili's Auto Rice Boostrapping Script (MARBS)
# by Mili Ahrari <m.ahrari77@gmail.com>
# License: GNU GPLv3

### OPTIONS AND VARIABLES ###

dotfilesrepo="https://github.com/saintmili/voidrice.git"
progsfile="https://raw.githubusercontent.com/saintmili/marbs/master/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Mili's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Mili" 10 60
